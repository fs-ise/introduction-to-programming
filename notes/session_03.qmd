...
- Make sure students are prepared for the typical exam question the Pivot-table creator: (../images/pivot-numbered.png) and then a list with the fields to select.
...
| --------: | ------------------------------------------------------------- | ---------------------------------------------- |
| 0–20 min  | Review the **Christmas gift** and **Course grading** homework | Slides 36–37; `exercises_with_solutions.xlsx`, sheets `Gift` and `Grading` |
| 20–35 min | Complete the **Sales table** exercise, if necessary           | Slides 51–52; `exercises.xlsx`, sheet `Sales_table` |
...
| 55–85 min | Complete the **Exporter** exercise                            | Slide 76; `exercises.xlsx`, sheets `Exporter_data` and `Exporter_pivot` |
| 85–90 min | Introduce the **Expeditioner** exercise                       | Slide 78; `exercises.xlsx`, sheets `Exped_data` and `Exped_pivot` |
...
::: {.teaching-file}
[In-class demo]{.teaching-label .teaching-label-demo} [`../materials/exercises.xlsx`](../materials/exercises.xlsx){.teaching-button .teaching-button-demo} -- Sheet: Sales_pivot
:::
...
- The two records are Transaction 277 — 1/9/2002 — London — Hammock — Catalog — Quantity 5 — Revenue 275; and Transaction 114 — 1/9/2002 — London — Hat - polar — Catalog — Quantity 4 — Revenue 136. Check that `275 + 136 = 411`.
