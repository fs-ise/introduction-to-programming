...
::: {.teaching-file}
[In-class demo]{.teaching-label .teaching-label-demo} [`../materials/data/Student_performance.csv`](../materials/data/Student_performance.csv){.teaching-button .teaching-button-demo}
:::
