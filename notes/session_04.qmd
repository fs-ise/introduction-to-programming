...
If Python does not work on student machines, a solution may be to use <https://peter-rossbach.github.io/Python-Werkstatt/>:

![](../images/qr_python_werkstatt.png){width=20% fig-align="center"}
...
| 15–35 min | Reading and inspecting Excel data | Slides 16–17; `Bikesales.xlsx` (TODO: missing) |
| 35–50 min | File paths and CSV input | Slides 18–19 |
| 50–65 min | Loading, previewing, and exporting data | Slide 20; `Exped_Table.xlsx` (missing) |
...
TODO: explain spyder interface. If it does not work for some students, ask them to work together with someone where it works. Setup was supposed to be completed in the first sessions.
...
is probably unnecessary because pandas is typically already available in the Spyder environment. Verify this for the installation used in the course.
