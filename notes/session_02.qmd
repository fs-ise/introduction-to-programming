...
2. Remainder (start with amount-redemption, copy down, validate. fix: previous remainder-redemption; also update the redemption to use an IF statement)
3. Interest rates
4. Sum
...
On the slides, the contribution of homework should be **9.11** and the overall grade **73.61**.

Show the correct version to students: **images/excel_grading_assignment.png**
